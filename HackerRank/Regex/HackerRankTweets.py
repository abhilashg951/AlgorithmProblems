"""
    ...
    Given a set of most popular tweets, 
    your task is to find out how many of those tweets has the string hackerrank in it.
...
def has_string(haystack, needle):
    return re.match('.*'+needle+'.*', haystack, re.IGNORECASE) is not None
...
if __name__ == "__main__":
    ...
    for _ in xrange(num_tests):
        result += 1 if has_string(raw_input(), needle) else 0
    print result
