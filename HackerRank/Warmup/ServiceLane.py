"""
	...
	The length of the highway and the service lane is N units. 
	...
	T test cases follow. Each test case contains two integers - i & j, 
	where i is the index of segment through which Calvin enters the service lane and j is the index of the lane segment where he exits.

	Output Format 
	For each test case, print T number that represents the largest vehicle type that can pass through the service lane.
